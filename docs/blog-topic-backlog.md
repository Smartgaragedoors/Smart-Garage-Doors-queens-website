...
- [SKIPPED] GSC 2026-08-23: "luxury garage doors" 68 imp @29.7 / "custom garage doors long island" 74 @38.8 — custom & luxury door options guide; links /garage-door-installation/ — **already covered**: `content/blog/best-garage-doors-luxury-homes-queens.json` (2026-06-10) targets the same "luxury/custom garage doors" intent and keywords almost exactly (insulated steel, carriage-style, custom wood, full-view glass, pricing by type). Publishing a near-duplicate would violate the "one intent, one page" rule (`08-agent-rules.md` #10). If this keyword gap is still real, the fix is to refresh/expand the existing post (e.g. add Long Island-specific framing) rather than spawn a new URL — leaving unchecked for a human to decide.
- [x] Garage door insulation R-values explained: what the tri-state climate actually requires (supports /garage-door-insulation/ — internal-link it) (2026-09-15, `garage-door-insulation-r-values-explained`)
- [x] Why is my garage door so loud? Noise diagnosis by sound (grinding vs. squeaking vs. banging) (2026-09-22, `garage-door-noise-diagnosis-by-sound`)
