...
export default function GarageDoorInstallationCostWestchesterPage() {
  return (
    <GuidePageTemplate
      metaTitle="Garage Door Installation Cost in Westchester County (2026 Prices)"
      ...
      whatsAppMessage="Hi, I'm in Westchester County and looking into a new garage door. Can I send you a few photos of my current door for an installation quote?"
      intro={[
        ...
        rows: [
          {
            ...
            range: '$800–$1,600',
            notes: 'Single-layer steel, classic panel styles, standard hardware',
          },
          {
            item: 'Insulated double-layer steel',
            range: '$1,200–$2,000',
            notes: 'Steel + polystyrene core; warmer and quieter for attached garages',
          },
          {
            item: 'Insulated triple-layer steel (premium quiet)',
            range: '$1,800–$2,800',
            notes: 'Steel-insulation-steel sandwich; top R-value, quietest daily operation',
          },
          {
            item: 'Carriage-style door',
            range: '$2,500–$6,500',
            notes: 'The Westchester favorite — overlay designs, decorative hardware, windows',
          },
          {
            item: 'Custom, wood, or full-view glass',
            range: '$4,000–$10,000+',
            notes: 'True wood, custom sizing for older openings, modern glass doors',
          },
          {
            item: 'Double-car door (16x7)',
            range: 'Add roughly 50–80%',
            notes: 'More material and reinforcement than a single, but not double the price',
          },
          {
            item: 'LiftMaster belt-drive WiFi opener (add-on)',
            range: '$450–$900 installed',
            notes: 'Quiet belt drive, myQ app, battery backup for outage-prone areas',
          },
        ],
      }}
      sections={[
        {
          heading: 'What Drives Garage Door Pricing in Westchester',
          paragraphs: [
        ...
        {
          heading: 'Attached Garage? Go Insulated and Quiet',
          paragraphs: [
        ...
        {
          heading: "What's Included in Our Installation Quote",
          paragraphs: [
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Carriage-style doors are the natural match — overlay designs with decorative hinges, handles, and optional windows that echo the swing-out doors these homes originally had. Modern carriage doors are insulated steel underneath, so you get the period look with today's R-value and quiet operation. For tudors and historic homes with unusual openings, custom sizing is common and something we handle regularly.",
        },
        {
          question: 'Can you replace the door on an old detached garage?',
          answer:
            "Yes — older village garages are a regular part of our work in Westchester. Low headroom, settled framing, and out-of-square openings all have standard solutions: low-headroom track kits, custom-sized doors, and on-site fitting. We'll flag anything structural we see during the estimate so there are no surprises on installation day.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "In some Westchester villages and communities, yes — door style, color, and window patterns may need sign-off before installation. We've specified doors to meet both HOA standards and historic-district guidelines; share the requirements with us and we'll recommend doors that fit them, with spec sheets you can submit for approval.",
        },
        {
          question: 'Do you offer financing on new garage doors?',
          answer:
            "Yes — financing and 0% promotional options are available on installation projects. It's a common route for homeowners moving up to an insulated triple-layer or carriage-style door. Ask about current options when you call or book your free estimate.",
        },
      ]}
      ...
      relatedLinks={{
        title: 'Westchester Towns We Serve',
        links: [
          { label: 'Westchester County, NY', href: '/westchester-county-ny/' },
          { label: 'Scarsdale, NY', href: '/scarsdale-ny/' },
          { label: 'Rye, NY', href: '/rye-ny/' },
          { label: 'Bronxville, NY', href: '/bronxville-ny/' },
          { label: 'Larchmont, NY', href: '/larchmont-ny/' },
          { label: 'Chappaqua, NY', href: '/chappaqua-ny/' },
          { label: 'Armonk, NY', href: '/armonk-ny/' },
          { label: 'Harrison, NY', href: '/harrison-ny/' },
        ],
      }}
