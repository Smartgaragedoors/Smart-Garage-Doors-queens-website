...
export default function LoadingDockDoorRepairPage() {
  return (
    <GuidePageTemplate
      ...
      bottomLine="A down bay door is a throughput problem, not just a door problem. We repair loading dock and bay doors for warehouses across NY, NJ & CT — 24/7 priority dispatch, high-cycle parts on the truck, and per-door records for multi-facility accounts. Send the door size and photos and we'll get you a number fast."
      relatedLinks={{
