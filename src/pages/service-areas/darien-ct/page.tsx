...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Darien, CT Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription="Garage door repair in Darien, CT — total-price quotes, 5.0★ reviews. Spring replacement, opener repair, emergency service. Licensed & insured. Call (914) 557-6816."
      ...
      reviews={[{"text":"Spring repair in Tokeneke. They were professional, on time, and the quality of work was excellent. Fair pricing for Darien.","author":"Carolyn J.","location":"Tokeneke, Darien","initials":"CJ","color":"bg-blue-600"},{"text":"New carriage-style door in Darien Center. Perfect installation — matched our colonial home beautifully.","author":"William P.","location":"Darien Center, CT","initials":"WP","color":"bg-orange-500"},{"text":"Emergency in Noroton Heights when door wouldn't close before a storm. They fixed a broken cable. Very grateful.","author":"Helen R.","location":"Noroton Heights, Darien","initials":"HR","color":"bg-green-600"}]}
      faqs={[{"question":"What areas of Darien do you cover?","answer":"All of Darien — the center, Tokeneke, Noroton, Darien Heights, Middlesex, Pear Tree Point, Long Neck Point, Noroton Heights, and West Darien."},{"question":"How does scheduling work in Darien?","answer":"Our Fairfield County technician covers Darien and the surrounding shoreline towns every week. We prioritize emergency calls and give you an exact ETA the moment you call."},{"question":"Do you install carriage-style garage doors in Darien?","answer":"Yes. Carriage-style and custom doors are among our most common installs in Darien. We work with premium brands that complement New England architecture."},{"question":"What does spring replacement cost in Darien?","answer":"Spring replacement runs $175–$350. Exact quote before we start."},{"question":"What brands do you service in Darien?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, Amarr — all major brands."},{"question":"Do you offer emergency service in Darien?","answer":"Yes — our emergency line is available, and a dispatcher gives you an honest arrival window when you call."}]}
