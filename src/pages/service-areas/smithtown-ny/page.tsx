...
export default function LocationPage() {
  useEffect(() => {
    ...
    s.text = JSON.stringify({
      ...
      geo: { '@type': 'GeoCoordinates', latitude: '40.8568', longitude: '-73.2007' },
