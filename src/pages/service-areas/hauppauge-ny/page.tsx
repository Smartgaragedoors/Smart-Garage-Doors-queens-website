...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      ...
      faqs={[{"question":"Do you service commercial garage doors in Hauppauge?","answer":"Yes. The Hauppauge Industrial Park is a significant part of our business. We service commercial roll-up doors, loading dock doors, and large-format commercial openers throughout the park."},{"question":"How fast can you reach Hauppauge?","answer":"Our Long Island team covers Hauppauge and the surrounding business corridor every week. We schedule efficiently to minimize your wait, especially for commercial clients, and give you an exact ETA when you call."},{"question":"What does garage door repair cost in Hauppauge?","answer":"Residential repairs start at $150–$300. Commercial jobs are quoted based on scope. We always provide pricing before work begins."},{"question":"Do you service residential garages in Hauppauge too?","answer":"Yes. About half our Hauppauge calls are residential — homeowners in the surrounding neighborhoods."},{"question":"What brands do you service in Hauppauge?","answer":"All brands — LiftMaster, Genie, Chamberlain, Amarr, Clopay, commercial-grade operators, and more."},{"question":"Do you offer emergency commercial garage door service in Hauppauge?","answer":"Yes. A commercial door stuck open or closed is an emergency — call anytime and we'll prioritize it."}]}
