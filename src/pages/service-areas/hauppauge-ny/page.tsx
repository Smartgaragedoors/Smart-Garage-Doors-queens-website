...
const HauppaugeNY = () => {
  useEffect(() => {
    ...
    canonical.setAttribute('href', `${import.meta.env.VITE_SITE_URL || 'https://smartestgaragedoors.com'}/hauppauge-ny/`);
    ...
    script.text = JSON.stringify({
      ...
      "url": `${import.meta.env.VITE_SITE_URL || 'https://smartestgaragedoors.com'}/hauppauge-ny/`,
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Smart Garage Doors provides 24/7 emergency garage door repair services in Hauppauge, NY. Our local technicians typically respond within 1-2 hours for urgent repairs, ensuring your home's security and your family's safety are quickly restored."
          }
        },
        {
          "@type": "Question",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="border-b border-gray-200 pb-6">
              ...
              <p className="text-gray-600">
                Smart Garage Doors provides 24/7 emergency garage door repair services in Hauppauge, NY. 
