...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      ...
      faqs={[{"question":"What areas of Edison do you cover?","answer":"All of Edison — Oak Tree Road corridor, Metuchen border area, Menlo Park Terrace, South Edison, North Brunswick border, and all surrounding neighborhoods."},{"question":"How fast can you reach Edison?","answer":"Our central NJ technician covers Edison and the surrounding Middlesex County communities every week. Same-day appointments are often available, and we give you an exact ETA the moment you call."},{"question":"What does spring replacement cost in Edison?","answer":"Spring replacement runs $175–$350. Upfront pricing — no surprises."},{"question":"What brands do you service in Edison?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, Amarr, and all major brands."},{"question":"Do you offer same-day service in Edison?","answer":"Yes. Our central NJ technician is in the area regularly, and same-day service is usually available in Edison."},{"question":"Do you service commercial garage doors in Edison?","answer":"Yes. We service commercial roll-up doors and commercial opener systems for Edison businesses."}]}
