...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      ...
      faqs={[{"question":"Do you serve all of Elizabeth, NJ?","answer":"Yes — downtown, Elmora, Weehawken Hill, Peterstown, Kesbrough, Bayway, Elizabethport, and all surrounding areas."},{"question":"How fast can you reach Elizabeth?","answer":"Elizabeth is about 60–75 minutes from our Suffern base and 45–60 minutes from our Brooklyn location. We'll give you an honest ETA."},{"question":"Do you handle commercial garage doors in Elizabeth?","answer":"Yes. We service commercial roll-up doors and industrial garage systems throughout Elizabeth, including the port area."},{"question":"What does spring replacement cost in Elizabeth?","answer":"Spring replacement runs $175–$350. Upfront pricing before we start."},{"question":"What brands do you service in Elizabeth?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, and all major brands."},{"question":"Do you offer emergency service in Elizabeth?","answer":"Yes, 24/7. For both residential and commercial emergency calls."}]}
