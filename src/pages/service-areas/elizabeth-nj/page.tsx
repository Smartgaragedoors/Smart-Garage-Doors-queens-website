...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Elizabeth, NJ Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription="Garage door repair in Elizabeth, NJ — total-price quotes, 5.0★ reviews. Spring replacement, opener repair, emergency service. Licensed & insured. Call (914) 557-6816."
      ...
      reviews={[{"text":"Commercial roll-up door at our Elizabeth warehouse. They came next day, assessed it, and had it working within a few hours. Minimal business disruption.","author":"Victor R.","location":"Elizabeth, NJ","initials":"VR","color":"bg-blue-600"},{"text":"Spring replacement in Elmora. Called in the morning, they came out. Professional, fair price.","author":"Maria S.","location":"Elmora, Elizabeth","initials":"MS","color":"bg-orange-500"},{"text":"New opener in my Elizabeth home. Tech was efficient and showed me how to set it up. Works great. Good service at a fair price.","author":"Carlos M.","location":"Elizabeth, NJ","initials":"CM","color":"bg-green-600"}]}
      faqs={[{"question":"Do you serve all of Elizabeth, NJ?","answer":"Yes — downtown, Elmora, Weehawken Hill, Peterstown, Kesbrough, Bayway, Elizabethport, and all surrounding areas."},{"question":"How does scheduling work in Elizabeth?","answer":"Our technicians cover Elizabeth and the surrounding Union County communities every week. Emergency calls are prioritized, and we'll give you an honest ETA the moment you call."},{"question":"Do you handle commercial garage doors in Elizabeth?","answer":"Yes. We service commercial roll-up doors and industrial garage systems throughout Elizabeth, including the port area."},{"question":"What does spring replacement cost in Elizabeth?","answer":"Spring replacement runs $175–$350. Upfront pricing before we start."},{"question":"What brands do you service in Elizabeth?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, and all major brands."},{"question":"Do you offer emergency service in Elizabeth?","answer":"Yes — our emergency line takes both residential and commercial emergency calls; a dispatcher confirms current availability."},{"question":"Is Smart Garage Doors a good choice for garage door repair in Elizabeth, NJ?","answer":`We think so. We're a registered NJ Home Improvement Contractor (Registration #13VH14195600), hold a ${BUSINESS_INFO.aggregateRating.ratingValue}★ rating across ${BUSINESS_INFO.aggregateRating.reviewCount}+ Google reviews, and back our work with a warranty on parts and labor. Every job gets an upfront quote before we start — no surprise charges. Call (914) 557-6816 to compare us yourself.`}]}
