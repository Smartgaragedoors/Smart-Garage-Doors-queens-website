...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Greenwich, CT Garage Door Repair | Same-Day Service | Smart Garage Doors"
      ...
      faqs={[{"question":"Do you specialize in high-end garage doors for Greenwich estates?","answer":"Yes. We work with premium brands and custom options suited for Greenwich's upscale properties. We're experienced working in high-value home environments."},{"question":"How fast can you reach Greenwich?","answer":"Our Fairfield County technician covers Greenwich and the surrounding communities every week. Same-day appointments are often available, and we give you an exact ETA the moment you call."},{"question":"What brands do you install in Greenwich?","answer":"Clopay, Wayne Dalton, Amarr, custom wood doors, and all major smart opener brands. We match the door to the home's architecture."},{"question":"What does a new garage door cost in Greenwich?","answer":"Standard installations start from $800. Custom or premium doors run higher — we provide a detailed quote before any work begins."},{"question":"Do you offer emergency service in Greenwich?","answer":"Yes, 24/7. Emergency calls in Greenwich are prioritized, and we give you an honest ETA the moment you call."},{"question":"Do you work in all Greenwich neighborhoods?","answer":"Yes — all areas from downtown to the Backcountry, Byram, Old Greenwich, Cos Cob, Riverside, and Belle Haven."}]}
