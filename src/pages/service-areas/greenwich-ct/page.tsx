...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Greenwich, CT Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription="Garage door repair in Greenwich, CT — total-price quotes, 5.0★ reviews. Spring replacement, opener repair, emergency service. Licensed & insured. Call (914) 557-6816."
      ...
      recentJobs={[
        {
          service: 'Three doors and motors on one property',
          area: 'Mid-country — Pecksland Road area',
          detail: 'A three-car setup where every door and opener needed attention. Repaired and refreshed all three doors and motors in a coordinated visit instead of three separate call-outs.',
          outcome: 'About $3,920 for the full three-door package, quoted as one total before work began.',
        },
      ]}
      reviews={[]}
      faqs={[{"question":"Do you specialize in high-end garage doors for Greenwich estates?","answer":"Yes. We work with premium brands and custom options suited for Greenwich's upscale properties. We're experienced working in high-value home environments."},{"question":"How does scheduling work in Greenwich?","answer":"Our Fairfield County technician covers Greenwich and the surrounding communities every week. We confirm current availability when you call and give you an exact ETA the moment you call."},{"question":"What brands do you install in Greenwich?","answer":"Clopay, Wayne Dalton, Amarr, custom wood doors, and all major smart opener brands. We match the door to the home's architecture."},{"question":"What does a new garage door cost in Greenwich?","answer":"Standard installations typically range $800–$2,500, total price inclusive of any fees, surcharges, and applicable taxes. Custom or premium doors run higher — we provide a detailed quote before any work begins."},{"question":"Do you offer emergency service in Greenwich?","answer":"Yes — our emergency line is available. Emergency calls in Greenwich are prioritized, and we give you an honest ETA the moment you call."},{"question":"Do you work in all Greenwich neighborhoods?","answer":"Yes — all areas from downtown to the Backcountry, Byram, Old Greenwich, Cos Cob, Riverside, and Belle Haven."}]}
