...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      ...
      metaDescription="Garage door repair & custom installation in Great Neck, NY. Custom wood & carriage-house doors, smart WiFi openers, licensed repair service. Licensed & insured. (914) 557-6816."
