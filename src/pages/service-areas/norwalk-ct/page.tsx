...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Norwalk, CT Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription="Garage door repair in Norwalk, CT — total-price quotes, 5.0★ reviews. Spring replacement, opener repair, emergency service. Licensed & insured. Call (914) 557-6816."
      ...
      reviews={[{"text":"Cable snapped in SoNo. Called, they fixed it. Professional and efficient. Would use again without hesitation.","author":"Nicole F.","location":"South Norwalk, CT","initials":"NF","color":"bg-blue-600"},{"text":"New garage door in West Norwalk. They walked us through the options, chose a beautiful Wayne Dalton carriage door, and installed it perfectly.","author":"Raymond B.","location":"West Norwalk, CT","initials":"RB","color":"bg-orange-500"},{"text":"Spring emergency in East Norwalk. They were here in about 90 minutes, replaced both springs, and the door runs great.","author":"Christine D.","location":"East Norwalk, CT","initials":"CD","color":"bg-green-600"}]}
      faqs={[{"question":"What areas of Norwalk do you serve?","answer":"All of Norwalk — South Norwalk, East Norwalk, Rowayton, West Norwalk, Cranbury, Silvermine, Broad River, Wolfpit, and surrounding areas."},{"question":"How does scheduling work in Norwalk?","answer":"Our Fairfield County technician covers Norwalk and the surrounding shoreline communities every week. Emergency calls get prioritized, and we give you an exact ETA the moment you call."},{"question":"Do you handle coastal garage doors in Norwalk?","answer":"Yes. We use corrosion-resistant hardware for homes near Rowayton and the Norwalk waterfront, where salt air accelerates wear."},{"question":"What does spring replacement cost in Norwalk?","answer":"Spring replacement runs $175–$350. Exact quote before we start."},{"question":"What brands do you service in Norwalk?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, and all major brands."},{"question":"Do you offer emergency service in Norwalk?","answer":"Yes — our emergency line is available, and a dispatcher gives you an honest arrival window the moment you call."}]}
