...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      ...
      faqs={[{"question":"What areas of Norwalk do you serve?","answer":"All of Norwalk — South Norwalk, East Norwalk, Rowayton, West Norwalk, Cranbury, Silvermine, Broad River, Wolfpit, and surrounding areas."},{"question":"How fast can you reach Norwalk?","answer":"Norwalk is 75–90 minutes from our Suffern base. Emergency calls get prioritized."},{"question":"Do you handle coastal garage doors in Norwalk?","answer":"Yes. We use corrosion-resistant hardware for homes near Rowayton and the Norwalk waterfront, where salt air accelerates wear."},{"question":"What does spring replacement cost in Norwalk?","answer":"Spring replacement runs $175–$350. Exact quote before we start."},{"question":"What brands do you service in Norwalk?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, and all major brands."},{"question":"Do you offer emergency service in Norwalk?","answer":"Yes, 24/7. We'll give you an honest ETA from our Suffern location."}]}
