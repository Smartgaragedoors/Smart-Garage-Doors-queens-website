...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Paramus, NJ Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription="Garage door repair in Paramus, NJ — total-price quotes, 5.0★ reviews. Spring replacement, opener repair, emergency service. Licensed & insured. Call (914) 557-6816."
      ...
      reviews={[{"text":"Commercial door at our Paramus location. Called, they came out, assessed the issue and fixed it. No downtime for the business.","author":"Stephen C.","location":"Paramus, NJ","initials":"SC","color":"bg-blue-600"},{"text":"Spring replacement at my house in east Paramus. Tech was professional, on time, and the price was fair. Would definitely call again.","author":"Lisa R.","location":"East Paramus, NJ","initials":"LR","color":"bg-orange-500"},{"text":"New opener installed in Paramus. Works perfectly with the app. Quick job, clean installation. Very happy with the service.","author":"Adam H.","location":"Paramus, NJ","initials":"AH","color":"bg-green-600"}]}
      faqs={[{"question":"What areas of Paramus do you serve?","answer":"All of Paramus — Route 4 and Route 17 corridors, east and west residential sections, and bordering areas near Ridgewood, Fair Lawn, Maywood, and Rochelle Park."},{"question":"How does scheduling work in Paramus?","answer":"Our Bergen County technician covers Paramus every week and knows the Routes 4 and 17 corridors well. We confirm current availability when you call and give you an exact ETA the moment you call."},{"question":"Do you service commercial properties in Paramus?","answer":"Yes. Commercial roll-up doors, loading dock systems, and commercial openers are a significant part of our Paramus business."},{"question":"What does garage door repair cost in Paramus?","answer":"Residential repairs start at $150–$300, spring replacement $175–$350. Commercial quotes are based on scope. Upfront pricing always."},{"question":"What brands do you service in Paramus?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, Amarr — all major brands."},{"question":"How does scheduling work in Paramus?","answer":"Yes. Bergen County is well within our regular routes — a dispatcher confirms current availability when you call."}]}
