...
export default function BrooklynNY() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Brooklyn NY Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription={`Garage door repair in Brooklyn, NY — upfront total-price quotes, ${BUSINESS_INFO.aggregateRating.ratingValue}★ ${BUSINESS_INFO.aggregateRating.reviewCount} reviews. Brownstone specialists. Licensed & insured.`}
      ...
      neighborhoods={[
        { name: 'Park Slope & Prospect Heights', description: 'Historic brownstones with narrow garages — we know them well. Our Dyker Heights-based technician covers Park Slope regularly.' },
        ...
        { name: 'Bay Ridge & Dyker Heights', description: 'This is our home base. We know Bay Ridge and Dyker Heights street by street.' },
      ...
      faqs={[
        ...
        { question: 'What does garage door repair cost in Brooklyn?', answer: 'Basic repairs run $150–$300, spring replacement runs $175–$350, opener repair $150–$350 — all totals inclusive of any fees, surcharges, and applicable taxes. We quote the exact price upfront — no surprises.' },
      ...
      comparisonRows={[
        { feature: 'Scheduling',          ours: 'Honest arrival window confirmed when you call' },
