...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="New Canaan, CT Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription="Garage door repair in New Canaan, CT — total-price quotes, 5.0★ reviews. Spring replacement, opener repair, emergency service. Licensed & insured. Call (914) 557-6816."
      ...
      faqs={[{"question":"Do you install custom garage doors in New Canaan?","answer":"Yes. New Canaan homes often call for custom and premium carriage-style doors. We carry and install top brands that complement New Canaan's New England architecture."},{"question":"How does scheduling work in New Canaan?","answer":"Our Fairfield County technician covers New Canaan and the neighboring towns every week. Emergency calls are prioritized, and we give you an exact ETA the moment you call."},{"question":"What does garage door repair cost in New Canaan?","answer":"Repairs run $150–$300 (total price inclusive of any fees, surcharges, and applicable taxes), spring replacement $175–$350, opener repair $150–$350. Exact quote upfront."},{"question":"What brands do you install in New Canaan?","answer":"Clopay, Wayne Dalton, Amarr, and premium custom brands — plus LiftMaster and Chamberlain for smart opener systems."},{"question":"Do you offer emergency service in New Canaan?","answer":"Our emergency line is available — call and a dispatcher confirms an honest arrival window based on current technician availability."},{"question":"Do you service all of New Canaan?","answer":"Yes — the center, Oenoke Ridge, Country Club Road, Silver Hill, Ponus Ridge, and all surrounding areas."}]}
