...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      ...
      faqs={[{"question":"What neighborhoods in White Plains do you serve?","answer":"All of White Plains — downtown, Battle Hill, Gedney Farms, Soundview, Ridgeway, North White Plains, Highlands, Fisher Hill, and surrounding areas."},{"question":"How quickly can you reach White Plains?","answer":"Our Suffern-based technician covers White Plains and all of Westchester. Most calls can be reached in 45–75 minutes."},{"question":"What does garage door repair cost in White Plains?","answer":"Repairs start at $150–$300, spring replacement $175–$350, opener repair $150–$350. We quote upfront before starting."},{"question":"Do you handle commercial garage doors in White Plains?","answer":"Yes. We service commercial roll-up doors and commercial opener systems for White Plains businesses and properties."},{"question":"What brands do you service in White Plains?","answer":"All major brands — LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, and more."},{"question":"Do you offer same-day service in White Plains?","answer":"Yes. With our Suffern-based technician, we can usually offer same-day service in White Plains. Call early for best availability."}]}
