...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Jackson, NJ Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription="Garage door repair in Jackson, NJ — upfront total-price quotes, 5.0★ reviews. Spring replacement, opener repair, emergency service. Licensed & insured. Call (914) 557-6816."
      ...
      reviews={[]}
      faqs={[{"question":"Is Jackson really your home base?","answer":"Yes! Our technician Yitzi is based in Jackson and covers the area every week — call us and we'll give you an honest arrival estimate based on current availability."},{"question":"What parts of Jackson do you cover?","answer":"All of Jackson — the center, Cassville, Prospertown, Legler, Whitesville, the Six Flags area, and all surrounding communities."},{"question":"What does garage door repair cost in Jackson?","answer":"Repairs run $150–$300, spring replacement $175–$350, opener $150–$350 — total prices inclusive of any fees, surcharges, and applicable taxes. Upfront pricing always."},{"question":"Do you also serve towns near Jackson?","answer":"Yes — Toms River, Howell, Manchester, Lakewood, Brick, and surrounding Ocean/Monmouth County towns are all within our service range."},{"question":"What brands do you service in Jackson?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, Amarr, and all major brands."},{"question":"How does scheduling work in Jackson?","answer":"Call and a dispatcher checks current technician availability — Jackson is our home base, so a crew is often nearby. Actual arrival time depends on the technician's current job, traffic, and your distance from our nearest crew; we confirm an honest window on the call."}]}
