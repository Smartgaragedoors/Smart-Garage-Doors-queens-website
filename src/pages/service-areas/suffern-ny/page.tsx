...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Garage Door Repair in Suffern, NY | Smart Garage Doors"
