...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      ...
      faqs={[{"question":"Why is Suffern your base?","answer":"Suffern is central to Rockland County, close to the NJ border, and gives us great access to northern NJ and the Hudson Valley. Our technician Ben is based here and knows the area extremely well."},{"question":"How fast can you reach Suffern?","answer":"Faster than anywhere else we serve — our technician is based right in Suffern, so local calls are usually our quickest dispatches. We confirm an honest ETA when you call."},{"question":"Do you serve areas around Suffern?","answer":"Yes — Airmont, Montebello, Wesley Hills, Pomona, Sloatsburg, Tuxedo, Hillburn, and across the border into Mahwah and Ramsey NJ."},{"question":"What does garage door repair cost in Suffern?","answer":"Repairs start at $150–$300, spring replacement $175–$350, opener $150–$350. Upfront pricing always."},{"question":"What brands do you service in Suffern?","answer":"All major brands — LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, Amarr, and more."},{"question":"Do you offer same-day service in Suffern?","answer":"Almost always. This is our home territory — we prioritize local calls and usually have same-day availability."},{"question":"Is Smart Garage Doors a good choice for garage door repair in Suffern?","answer":"Yes — we're a licensed (NY DCWP #2130164-DCWP), insured company with a 5.0★ average from 479+ Google reviews, including customers right here in Suffern. We back our work with upfront pricing (no surprise fees) and a warranty on parts and labor. Suffern is our home base, so you're calling a technician who lives and works in this area. Call (845) 262-2034 to check availability."}]}
