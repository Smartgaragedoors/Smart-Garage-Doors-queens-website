...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Newtown, CT Garage Door Repair | Same-Day Service | Smart Garage Doors"
      ...
      faqs={[{"question":"Do you serve all of Newtown, CT?","answer":"Yes — Newtown Center, Sandy Hook, Hawleyville, Botsford, Dodgingtown, Zoar, Taunton, Stepney, Berkshire, and all of Newtown."},{"question":"Do you offer same-day service in Newtown?","answer":"Often, yes. Our Fairfield County technician covers Newtown and the surrounding communities. We schedule visits efficiently and always provide an honest ETA when you call."},{"question":"What does garage door repair cost in Newtown?","answer":"Repairs start at $150–$300, spring replacement $175–$350. Upfront quotes before any work starts."},{"question":"Do you install carriage-style doors in Newtown?","answer":"Yes. Given Newtown's New England character, carriage-style and traditional wood-look doors are very popular. We carry a great selection."},{"question":"What brands do you service in Newtown?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, and all major brands."},{"question":"Do you offer same-day service in Newtown?","answer":"We offer same-day service when availability allows. Given the distance, call early for best results."}]}
