...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Newtown, CT Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription="Garage door repair in Newtown, CT — total-price quotes, 5.0★ reviews. Spring replacement, opener repair, emergency service. Licensed & insured. Call (914) 557-6816."
      ...
      reviews={[{"text":"Spring repair in Sandy Hook. They drove from NY, arrived when they said they would, and fixed it perfectly. Fair price, professional service.","author":"Thomas N.","location":"Sandy Hook, Newtown","initials":"TN","color":"bg-blue-600"},{"text":"New garage door in Newtown Center. Beautiful carriage-style door that fits the colonial home perfectly. Installation was quick and clean.","author":"Patricia A.","location":"Newtown Center, CT","initials":"PA","color":"bg-orange-500"},{"text":"Emergency call when door wouldn't open in winter. They came out, fixed a broken cable, and also lubricated everything. Great service.","author":"Gerald S.","location":"Newtown, CT","initials":"GS","color":"bg-green-600"}]}
      faqs={[{"question":"Do you serve all of Newtown, CT?","answer":"Yes — Newtown Center, Sandy Hook, Hawleyville, Botsford, Dodgingtown, Zoar, Taunton, Stepney, Berkshire, and all of Newtown."},{"question":"How does scheduling work in Newtown?","answer":"Often, yes. Our Fairfield County technician covers Newtown and the surrounding communities. We schedule visits efficiently and always provide an honest ETA when you call."},{"question":"What does garage door repair cost in Newtown?","answer":"Repairs run $150–$300 (total price inclusive of any fees, surcharges, and applicable taxes), spring replacement $175–$350. Upfront quotes before any work starts."},{"question":"Do you install carriage-style doors in Newtown?","answer":"Yes. Given Newtown's New England character, carriage-style and traditional wood-look doors are very popular. We carry a great selection."},{"question":"What brands do you service in Newtown?","answer":"LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, and all major brands."},{"question":"How does scheduling work in Newtown?","answer":"Availability depends on the day's schedule. Given the distance, call early for best results."}]}
