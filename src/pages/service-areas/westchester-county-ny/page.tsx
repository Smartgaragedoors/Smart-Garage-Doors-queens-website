...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Westchester County, NY Garage Door Repair | Licensed & Insured | Smart Garage Doors"
      metaDescription="Garage door repair in Westchester County, NY — total-price quotes, 5.0★ reviews. Spring replacement, opener repair, emergency service. Licensed & insured. Call (914) 557-6816."
      ...
      faqs={[{"question":"What parts of Westchester County do you serve?","answer":"All of Westchester — Yonkers, White Plains, Scarsdale, New Rochelle, Pelham, Rye, Port Chester, Chappaqua, Briarcliff Manor, Tarrytown, Sleepy Hollow, Mount Vernon, Bronxville, Larchmont, and more."},{"question":"How does scheduling work in Westchester?","answer":"Our Westchester-area technician covers the entire county and gives an honest ETA the moment you call."},{"question":"What does garage door repair cost in Westchester?","answer":"Repairs run $150–$300 (total price inclusive of any fees, surcharges, and applicable taxes), spring replacement $175–$350, opener repair $150–$350, new installation $800–$2,500 (total price inclusive of any fees, surcharges, and applicable taxes)."},{"question":"Do you install premium garage doors in Westchester?","answer":"Yes. We work with all premium brands and custom styles for Westchester's upscale homes."},{"question":"Do you offer emergency service throughout Westchester?","answer":"Yes — our emergency line is available. Call and a dispatcher checks our Westchester technician's current availability."},{"question":"What brands do you service in Westchester?","answer":"All brands — LiftMaster, Chamberlain, Genie, Clopay, Wayne Dalton, Amarr, and custom brands."}]}
