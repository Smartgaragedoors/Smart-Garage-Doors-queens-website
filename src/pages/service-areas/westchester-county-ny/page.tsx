...
export default function LocationPage() {
  useEffect(() => {
    ...
    s.text = JSON.stringify({
      ...
      '@type': 'LocalBusiness',
      name: 'Smart Garage Doors - Westchester NY',
      url: buildCanonical('/westchester-county-ny'),
      ...
      geo: { '@type': 'GeoCoordinates', latitude: '41.1220', longitude: '-73.7949' },
