...
export default function LocationPage() {
  ...
  return (
    <LocationPageTemplate
      metaTitle="Teaneck, NJ Garage Door Repair | Same-Day Service | Smart Garage Doors"
