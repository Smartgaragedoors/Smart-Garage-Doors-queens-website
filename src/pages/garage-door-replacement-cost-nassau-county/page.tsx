...
export default function GarageDoorReplacementCostNassauCountyPage() {
  return (
    <GuidePageTemplate
      metaTitle="Garage Door Replacement Cost in Nassau County (2026 Prices)"
      metaDescription="What a new garage door costs in Nassau County & Long Island in 2026 — installed price ranges for steel, insulated, carriage, and custom doors."
      ...
      whatsAppMessage="Hi, I'm in Nassau County and thinking about replacing my garage door. Can I send you a few photos for a replacement quote?"
      intro={[
      ...
      costTable={{
        title: '2026 Garage Door Replacement Costs in Nassau County',
        caption:
        ...
        rows: [
          {
            ...
            range: '$800–$1,600',
            notes: 'Single-layer steel, basic panel styles, standard hardware',
          },
          {
            item: 'Insulated double-layer steel',
            range: '$1,200–$2,000',
            notes: 'Steel + polystyrene backing; warmer, sturdier, quieter',
          },
          {
            item: 'Insulated triple-layer steel (premium quiet)',
            range: '$1,800–$2,800',
            notes: 'Steel-insulation-steel sandwich; best R-value and quietest operation',
          },
          {
            item: 'Carriage-style door',
            range: '$2,500–$6,500',
            notes: 'Overlay or stamped carriage designs, decorative hardware, window options',
          },
          {
            item: 'Custom, wood, or full-view glass',
            range: '$4,000–$10,000+',
            notes: 'True wood, custom sizing, aluminum-and-glass modern doors',
          },
          {
            item: 'Double-car door (16x7)',
            range: 'Add roughly 50–80%',
            notes: 'Wider doors cost more in materials and reinforcement, not double',
          },
          {
            item: 'LiftMaster belt-drive WiFi opener (add-on)',
            range: '$450–$900 installed',
            notes: 'Quiet belt drive, myQ smartphone control, battery backup options',
          },
        ],
      }}
      sections={[
        {
          heading: 'What Drives the Price on a Long Island Home',
          paragraphs: [
        ...
        {
          heading: 'Why Insulated Doors Pay Off in Nassau County',
          paragraphs: [
        ...
        {
          heading: "What's Included in Our Quote",
          paragraphs: [
        ...
        {
          heading: 'How to Budget: Good, Better, Best',
          paragraphs: [
      ...
      faqs={[
        {
          question: 'How much does a new garage door cost in Nassau County?',
          answer:
            "Most replacements land between $800 and $2,800 installed: roughly $800–$1,600 for a standard single steel door and $1,200–$2,800 for an insulated double- or triple-layer door. Carriage-style doors run $2,500–$6,500, and custom, wood, or full-view glass doors run $4,000–$10,000+. These are typical ranges for our service area — every home differs, so we confirm the exact price upfront before any work begins.",
        },
        {
          question: 'Is an insulated garage door worth it on Long Island?',
          answer:
            "For most Nassau County homes, yes. The majority of houses here have attached garages, and many have living space above or beside them. An insulated double- or triple-layer door keeps that whole zone warmer in winter, runs noticeably quieter, and holds up better to daily use because the sandwich construction makes panels stiffer. If your garage is detached and you only park in it, a standard steel door is usually fine.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "It's consistently one of the strongest remodeling investments you can make. Exterior and garage door projects regularly rank at or near the top of cost-vs-value remodeling studies because the door is a huge part of your home's street-facing facade and buyers notice it immediately. On a typical Long Island colonial or split, a faded or dented door drags the whole front of the house down — a new one does the opposite.",
        },
        {
          question: 'Do you remove and haul away the old door?',
          answer:
            "Yes. Removal and disposal of your old door, tracks, and hardware is typically included in our quotes — no dumpster fees or doors leaning against your garage for weeks. We also install fresh tracks and rollers rather than hanging a new door on worn hardware.",
        },
        {
          question: 'Do you offer financing on garage door replacement?',
          answer:
            "Yes — financing and 0% promotional options are available on door replacement projects. Many homeowners use it to step up from a basic steel door to an insulated or carriage-style door without changing their monthly budget much. Ask about current options when you call or book your free estimate.",
        },
      ]}
      bottomLine="A new garage door in Nassau County runs anywhere from about $800 for a standard steel single to $10,000+ for custom wood or glass — but most homeowners land between $1,200 and $2,800 on a quality insulated door that's quieter, warmer, and better-looking than what it replaces. Text us photos of your current door and we'll give you a straight answer on what fits your home and exactly what it costs, before any work begins."
      relatedLinks={{
        title: 'Nassau County Towns We Serve',
        links: [
          { label: 'Nassau County, NY', href: '/nassau-county-ny/' },
          { label: 'Great Neck, NY', href: '/great-neck-ny/' },
          { label: 'Manhasset, NY', href: '/manhasset-ny/' },
          { label: 'Roslyn, NY', href: '/roslyn-ny/' },
          { label: 'Port Washington, NY', href: '/port-washington-ny/' },
          { label: 'Garden City, NY', href: '/garden-city-ny/' },
          { label: 'Syosset, NY', href: '/syosset-ny/' },
          { label: 'Old Westbury, NY', href: '/old-westbury-ny/' },
        ],
      }}
