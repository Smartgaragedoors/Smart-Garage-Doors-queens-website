...
export default function CommercialGarageDoorRepairPage() {
  return (
    <GuidePageTemplate
      ...
      criteria={{
        title: 'Why Facilities Teams Use Us',
        ...
        cards: [
          ...
          {
            title: 'One Vendor Across NY, NJ & CT',
            description:
          ...
          {
            title: 'High-Cycle Commercial Parts',
            description:
      ...
      sections={[
        {
          heading: 'Commercial Doors and Gates We Repair',
          paragraphs: [
        ...
        {
          heading: 'High-Cycle Springs: Why Commercial Doors Eat Residential Parts',
          paragraphs: [
        ...
        {
          heading: 'Downtime Is the Real Cost — So We Treat It That Way',
          paragraphs: [
        ...
        {
          heading: 'Recurring Service and Multi-Location Accounts',
          paragraphs: [
      ...
      faqs={[
        {
          question: 'Do you repair commercial overhead doors and rolling gates?',
          answer:
            'Yes. We repair commercial overhead sectional doors, rolling steel service doors and security gates, loading dock doors, and storefront gates — including springs, cables, tracks, slats, barrels, and the commercial operators that drive them. We handle both emergency repairs and scheduled service across NY, NJ, and Fairfield County, CT.',
        },
        {
          question: 'Do you offer maintenance contracts?',
          answer:
            'Yes. We run scheduled preventive maintenance programs — typically quarterly inspections of springs, cables, rollers, tracks, and operators on every door at your facility, with a written condition report after each visit. Worn parts get flagged and replaced on your schedule, which is how you stop paying for emergency downtime. Call and ask about a maintenance plan sized to your door count.',
        },
        {
          question: 'Can you service multiple locations?',
          answer:
            'Yes — multi-location accounts are a core part of our commercial work. One client, a national logistics operator, uses us for recurring service at their New York facility and brought us in to cover a facility in New Jersey as well. You get one point of contact, consistent pricing across sites, and service history kept per door at every location.',
        },
        {
          question: 'Do you provide COIs?',
          answer:
