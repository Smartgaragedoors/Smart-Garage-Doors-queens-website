...
export default function PedestrianGarageDoorsPage() {
  return (
    <GuidePageTemplate
      metaTitle="Pedestrian Garage Doors | Walk-Through Door Built In | NY, NJ & CT"
      metaDescription="Custom garage doors with a built-in pedestrian (wicket) door for walk-through access. Sizing, installation, and honest FAQs — serving NY, NJ & CT."
      keywords="pedestrian garage door, wicket door garage, garage door with walk through door, garage door with man door built in, walk through garage door panel"
      ...
      subheadline="A smaller walk-through door set right into one panel of your garage door — so you can step in and out without cycling the whole door. Custom sized, professionally installed."
      ...
      faqs={[
        {
          ...
          answer:
            "It's a garage door with a smaller, human-sized door built into one of the lower panels, letting you walk in and out without opening the full door. It's also called a wicket door, a man door, or a walk-through garage door.",
        },
        {
          question: 'Can I add a pedestrian door to my existing garage door?',
          answer:
            "Usually not to the door itself — cutting a walk-through opening into an existing panel isn't something we do, since that panel needs to be engineered from the start to carry the door's weight and travel safely around the track. A pedestrian door is typically built into a new custom door sized for your opening. If side-yard access is the actual goal, ask us about alternatives too, like a separate exterior man door installed nearby.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Several major manufacturers offer pedestrian/wicket door options on select sectional door lines. We'll walk you through which of our brands support it for your door size and style, and spec the right one for your opening.",
        },
        {
