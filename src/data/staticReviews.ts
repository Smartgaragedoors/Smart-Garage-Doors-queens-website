...
const CURATED_FALLBACK: StaticReview[] = [
  {
    ...
    rating: 5,
    text: 'Spring broke on a Sunday morning and my car was stuck in the garage. Called Smart Garage Doors and they got a tech out to my Forest Hills house. Fixed both springs, explained what failed and why, and the price was exactly what they quoted. Incredible service.',
    time: twoWeeksAgo,
  ...
  },
  {
    ...
    author_name: 'Tony B.',
    rating: 5,
    text: 'My garage door opener died right before a snowstorm in Flushing. They scheduled the visit, replaced the LiftMaster unit, and even reprogrammed my car\'s built-in remote. Tech was professional, no upselling, no nonsense. This is my go-to company now.',
    time: oneMonthAgo,
  ...
  },
  {
    ...
    author_name: 'Maria V.',
    rating: 5,
    text: 'Called at 8pm after my door came off the track in Dyker Heights, Brooklyn. Was worried nobody would come out that late. Smart Garage Doors picked up the call and got someone out that evening. Door was back on track. Fair price for emergency service.',
    time: twoMonthsAgo,
  ...
  },
  {
    ...
    author_name: 'Diana K.',
    rating: 5,
    text: 'I manage several rental properties in Queens and use Smart Garage Doors for all of them. They\'re reliable, show up when they say they will, and the pricing is consistent. Had cables replaced on two units in Astoria last month — clean job, no issues.',
    time: threeMonthsAgo,
  ...
  },
  {
    ...
    rating: 5,
    text: 'Torsion spring snapped on my garage in Suffern and the door was completely stuck. Tech showed up, diagnosed the problem on the spot, and replaced both springs so the other one wouldn\'t fail soon after. Smart call — honest advice.',
    time: fourMonthsAgo,
