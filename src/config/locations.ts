...
export const existingLocations: Location[] = [
  ...
  { slug: 'flushing-ny', city: 'Flushing', state: 'New York', stateAbbr: 'NY', county: 'Queens County' },
  { slug: 'forest-hills-ny', city: 'Forest Hills', state: 'New York', stateAbbr: 'NY', county: 'Queens County' },
  { slug: 'bayside-ny', city: 'Bayside', state: 'New York', stateAbbr: 'NY', county: 'Queens County' },
  { slug: 'great-neck-ny', city: 'Great Neck', state: 'New York', stateAbbr: 'NY', county: 'Nassau County' },
  { slug: 'manhasset-ny', city: 'Manhasset', state: 'New York', stateAbbr: 'NY', county: 'Nassau County' },
  { slug: 'roslyn-ny', city: 'Roslyn', state: 'New York', stateAbbr: 'NY', county: 'Nassau County' },
  { slug: 'port-washington-ny', city: 'Port Washington', state: 'New York', stateAbbr: 'NY', county: 'Nassau County' },
  { slug: 'garden-city-ny', city: 'Garden City', state: 'New York', stateAbbr: 'NY', county: 'Nassau County' },
  { slug: 'rye-ny', city: 'Rye', state: 'New York', stateAbbr: 'NY', county: 'Westchester County' },
  { slug: 'bronxville-ny', city: 'Bronxville', state: 'New York', stateAbbr: 'NY', county: 'Westchester County' },
  { slug: 'larchmont-ny', city: 'Larchmont', state: 'New York', stateAbbr: 'NY', county: 'Westchester County' },
  { slug: 'chappaqua-ny', city: 'Chappaqua', state: 'New York', stateAbbr: 'NY', county: 'Westchester County' },
  { slug: 'whitestone-ny', city: 'Whitestone', state: 'New York', stateAbbr: 'NY', county: 'Queens County' },
  { slug: 'jamaica-estates-ny', city: 'Jamaica Estates', state: 'New York', stateAbbr: 'NY', county: 'Queens County' },
  { slug: 'syosset-ny', city: 'Syosset', state: 'New York', stateAbbr: 'NY', county: 'Nassau County' },
  { slug: 'oyster-bay-ny', city: 'Oyster Bay', state: 'New York', stateAbbr: 'NY', county: 'Nassau County' },
  { slug: 'rockville-centre-ny', city: 'Rockville Centre', state: 'New York', stateAbbr: 'NY', county: 'Nassau County' },
  { slug: 'old-westbury-ny', city: 'Old Westbury', state: 'New York', stateAbbr: 'NY', county: 'Nassau County' },
  { slug: 'mamaroneck-ny', city: 'Mamaroneck', state: 'New York', stateAbbr: 'NY', county: 'Westchester County' },
  { slug: 'harrison-ny', city: 'Harrison', state: 'New York', stateAbbr: 'NY', county: 'Westchester County' },
  { slug: 'armonk-ny', city: 'Armonk', state: 'New York', stateAbbr: 'NY', county: 'Westchester County' },
  ...
  { slug: 'ridgewood-nj', city: 'Ridgewood', state: 'New Jersey', stateAbbr: 'NJ', county: 'Bergen County' },
  { slug: 'tenafly-nj', city: 'Tenafly', state: 'New Jersey', stateAbbr: 'NJ', county: 'Bergen County' },
  { slug: 'rumson-nj', city: 'Rumson', state: 'New Jersey', stateAbbr: 'NJ', county: 'Monmouth County' },
  { slug: 'holmdel-nj', city: 'Holmdel', state: 'New Jersey', stateAbbr: 'NJ', county: 'Monmouth County' },
  { slug: 'alpine-nj', city: 'Alpine', state: 'New Jersey', stateAbbr: 'NJ', county: 'Bergen County' },
  { slug: 'fort-lee-nj', city: 'Fort Lee', state: 'New Jersey', stateAbbr: 'NJ', county: 'Bergen County' },
  { slug: 'colts-neck-nj', city: 'Colts Neck', state: 'New Jersey', stateAbbr: 'NJ', county: 'Monmouth County' },
  { slug: 'red-bank-nj', city: 'Red Bank', state: 'New Jersey', stateAbbr: 'NJ', county: 'Monmouth County' },
];
